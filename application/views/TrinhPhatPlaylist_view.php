									...
									<div class="card">
										<div class="row">
											...
											<div class=" name-title col-md-7">
												...
												<span>-</span>
												<h4 class="card-title" id="tencasi"><a href="<?php echo base_url() ?>ThongTinCaSi/casi/<?php echo $obj_baihat['idcasi'] ?>" ><?php echo $obj_playlist['tencasi']?></a></h4>
											</div>
											...
											<div class="lyric" id="_divLyricHtml">
												...
												<div id="divLyric" class="pd_lyric trans" style="height:auto;max-height:300px;overflow:scroll;">
													...
													<table class="table table-striped" id="BaiHat-TBL">
														<?php if(count($listbaihat['danhsachbaihat'])===0){ ?>
