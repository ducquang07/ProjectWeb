					...
					<section class="main-content">
						<div class="col-sm-12">
							<section class="row">
										...
										<div class="row">
											...
											<div class=" name-title col-md-7">
												<div class="mb-4">
													...
													<p></p>
													<h3 class="card-title" id="tenbaihat"><?php echo $obj_playlist['tenplaylist']?></h3>
													<span>-</span>
													<h4 class="card-title" id="tencasi"><a href="<?php echo base_url() ?>ThongTinCaSi/casi/<?php echo $obj_baihat['tenbaihat'] ?>" ><?php echo $obj_playlist['tencasi']?></a></h4>
												</div>
												
												<p class="col-md-7 text-center" id="baihat_dangphat">
													<h5>Đang phát : <a href="#"><?php echo $obj_baihat['tenbaihat'] ?></a></h5>
													Thể hiện : 
								...
								<div class="card">
									<audio controls autoplay><source src="<?php echo $obj_baihat['duongdannhac']?>" type="audio/mpeg">
									</audio>
								</div>
								<div class="card mb-4">
									<div class="">
