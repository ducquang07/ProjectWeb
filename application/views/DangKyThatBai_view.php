...
<head>
	...
	<title>Đăng ký không thành công</title>
	...
	<div class="container">
		<h4 class="text-xs-center">
			<div class="alert alert-danger">
				Đã có <strong>lỗi</strong> trong quá trình đăng ký, Vui lòng thử lại. Đang chuyển hướng vui lòng chờ.... <i class="fa fa-chevron-circle-right rotate360"></i>
			</div>
		</h4>
	</div>
</body>
