							...
							<div class="mb-4  service-bar container" >
								<div class="row">
									<div class="user-upload">
										<img width="50" height="auto" class="circle float-left profile-photo" alt="profile photo" src="<?php foreach ($nguoidang['thongtinnguoidang'] as $key => $value) {
											echo $value['duongdananh'];
										}?>">
										Upload bởi:<br>
										<a href="#" id="name-user-upload"><?php foreach ($nguoidang['thongtinnguoidang'] as $key => $value) {
											echo $value['ten'];
										}?></a>
									</div>
									<ul id="menu-dichvu">
								...
								<div class="card-block">
									<div class="lyric" id="_divLyricHtml">
										<div class="pd_name_lyric">
											...
											<p class="name_post">Lời đăng bởi: <a rel="nofollow" href="#" title="philiplee"><?php foreach ($nguoidang['thongtinnguoidang'] as $key => $value) {
												echo $value['ten'];
											}?></a></p>
										</div>
										...
										<div class="container">
											<div class=" row">
												<p class="col-md-3 avatar">
													<img width="100" height="auto" class="photo-user-comment" alt="profile photo" src="<?php foreach ($nguoidung['thongtinnguoidung'] as $key => $value) {
														echo $value['duongdananh'];
													}?>">
												</p>
