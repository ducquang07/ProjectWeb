...
<body id="page-top">
  ...
  <header class="masthead text-center text-white d-flex" id="home">
      <div class="background-wrap">
        ...
        <source src="<?php echo base_url() ?>video/Coldplay - Paradise (Official Video).mp4" type="video/mp4">
          Video not supported
        </video>          
      </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-12">
          <form action="/action_page.php" >
            ...
            <p><center>Don't have an account? <a href="sign-up-form.html" style="color:dodgerblue">Sign up</a></center></p>
...
<!--    <section id="about-3">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4" id="cap-about">Discover</h2>
            <p>Enjoy new music with your own personal playlist. Or sit back and enjoy Radio.</p>
          </div>
        </div>
      </div>
    </div>
